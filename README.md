...
# 28 : Add all type wallpaper support . ( MOTION,INFINITY,VIDEO,INCONSISTENCY )

       <SEC_FLOATING_FEATURE_LOCKSCREEN_CONFIG_WALLPAPER_STYLE>MOTION,INFINITY,VIDEO,INCONSISTENCY</SEC_FLOATING_FEATURE_LOCKSCREEN_CONFIG_WALLPAPER_STYLE>

# 29 : Add dual sim volte
